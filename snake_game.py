...
class snake(object):
    ...
    def __init__(self, color, pos):
        ...
        self.dirnx = 0 # direction of snake in x axis
        self.dirny = 1 # direction of snake in y axis
    ...
    def move(self):
        for event in pygame.event.get():
            ...
            for key in keys:
                if keys[pygame.K_LEFT] and self.dirnx == 0:
                    self.dirnx = -1
                    self.dirny = 0
                    self.turns[self.head.pos[:]] = [self.dirnx, self.dirny]

                elif keys[pygame.K_RIGHT]  and self.dirnx == 0:
                    self.dirnx = 1
                    self.dirny = 0
                    self.turns[self.head.pos[:]] = [self.dirnx, self.dirny]

                elif keys[pygame.K_UP] and self.dirny == 0:
                    self.dirnx = 0
                    self.dirny = -1
                    self.turns[self.head.pos[:]] = [self.dirnx, self.dirny]

                elif keys[pygame.K_DOWN] and self.dirny == 0:
                    self.dirnx = 0
                    self.dirny = 1
                    self.turns[self.head.pos[:]] = [self.dirnx, self.dirny]
...
def randomSnack(rows: int, item: snake):
    positions = item.body
    while True:
